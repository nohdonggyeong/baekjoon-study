package backjoon.알고리즘_분류.시뮬레이션.boj_4991_로봇_청소기;
...
public class Main_시간_느리고_모든_케이스_비교하는_코드 {
	static int w, h;
	static char[][] map;
	...
	static int bfs(Node start, Node end) {
		Queue<Node> queue = new LinkedList<Main_시간_느리고_모든_케이스_비교하는_코드.Node>();
		queue.offer(start);
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			map = new char[h][w];
			candidates = new ArrayList<Main_시간_느리고_모든_케이스_비교하는_코드.Node>();
			for (int r = 0; r < h; r++) {
